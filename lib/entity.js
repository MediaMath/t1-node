...
Entity.prototype.saveJson = function (endpoint, connection) {
...
Entity.prototype.saveFormData = function (endpoint, connection) {
  const that = this;
...
Entity.prototype.getPostFormData = function () {
  const that = this;
  return SchemaProcessing.getSchema(that.entity_type)
    .then((schema) => {
